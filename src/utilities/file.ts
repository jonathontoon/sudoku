 ...
 */
export const create = (filename: string, content: string): void => {
 ...
 */
export const append = (filename: string, content: string): void => {
 ...
 */
export const open = (filename: string, delimiter: string = "\n"): string[] => {
  try {
